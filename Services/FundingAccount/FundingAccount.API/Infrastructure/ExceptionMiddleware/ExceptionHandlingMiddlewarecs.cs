...
namespace FundingAccount.API.Infrastructure.ExceptionMiddleware
{
    public class ExceptionHandlingMiddleware //: IMiddleware
    {
        ...
        private IList<ErrorDetails> GetErrDetailsFromUtility(IUtilityService utilityService, string errorCategory, string vendorCode, string lobCode)
        {
            ...
            using var errorDetailContent = new StreamReader(response.Content.ReadAsStream());

            var errList = errorDetailContent.ReadToEnd();
            ...
            //if (lstErrorDetails.Count() == 0)
            //{
            //    throw new NotFoundException("NotFound", "Aci", "Met_sfd");
            //}
